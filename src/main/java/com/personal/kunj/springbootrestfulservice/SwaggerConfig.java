...
public class SwaggerConfig {
	...
	public static final Contact DEFAULT_CONTACT = new Contact("Kunj Biahri", "www.kunjbihari.com",
			"kunj.bihari@abc.com");
	public static final ApiInfo DEFAULT_API_INFO = new ApiInfo("Kunj's API Title", "Kunj's API Description", "1.0",
